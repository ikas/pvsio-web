...
function Gauge(gaugeName, configuration) {
  ...
  this.render = function() {
    ...
    // Render pointer base circle
    if(this.config.pointerUseBaseCircle && !this.config.pointerBaseCircleAbovePointer) {
      this.disk.drawCircle(this.config.pointerBaseCircleRadius, {
        fill: this.config.pointerBaseCircleFillColor,
        stroke: this.config.pointerBaseCircleStrokeColor,
        "stroke-width": this.config.pointerBaseCircleStrokeWidth
      });
    }
  ...
  this.renderDisk = function() {
    ...
    if(this.config.drawGap) {
      ...
      if (this.config.drawOuterCircle) {
        this.disk.drawArc(
          this.valueToDegrees(this.config.min),
          this.valueToDegrees(this.config.max),
          this.config.cutOutPercetage,
          1,
          {
            fill: this.config.innerFillColor,
            stroke: this.config.innerStrokeColor,
  ...
  this.renderPointer = function() {
    ...
    pointerContainer.selectAll("path")
      ...
      .enter().append("svg:path")
        .attr("d", pointerLine)
        .style("fill", this.config.pointerFillColor)
        .style("stroke", this.config.pointerStrokeColor)
        .style("fill-opacity", this.config.pointerOpacity);
    fontSize = Math.round(this.config.labelSize * this.config.size / 2);
    if(this.config.pointerShowLabel) {
